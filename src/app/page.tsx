   ...
   const features = [
      {
         ...
         title: '18+ Components',
         description: 'Production-ready UI components with variants and full customization',
      ...
      },
      {
         icon: SparklesIcon,
         title: 'Animations',
         description: '16 keyframes, easing functions, and hover effects for polished UX',
         ...
         <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
            ...
            <div className="text-center mb-16 sm:mb-24 animate-fade-in">
               ...
               <h1 className="text-4xl sm:text-6xl font-bold text-[var(--color-text-primary)] mb-4 sm:mb-6 tracking-tight">
                  Cyber<span className="gradient-text">UI</span> Framework
               </h1>
               <p className="text-lg sm:text-xl text-[var(--color-text-secondary)] max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed">
                  Professional UI component library with cyber terminal design system.
                  <br className="hidden sm:block" />
                  <span className="text-[var(--color-text-muted)]">
                     18+ production-ready components, fully typed with TypeScript.
                  </span>
               </p>
               ...
               <CardContent>
                  <div className="space-y-4">
                     ...
                     <div className="rounded-xl bg-[var(--color-deep)] border border-[var(--color-border)] p-4 sm:p-6 font-mono text-sm overflow-x-auto">
                        ...
                        <div className="space-y-2">
                           <p className="text-[var(--color-text-muted)]">
                              <span className="text-[var(--color-neon-primary)]">$</span> git clone
                              https://github.com/your-org/cyber-ui
                           </p>
                           <p className="text-[var(--color-text-muted)]">
                              <span className="text-[var(--color-neon-primary)]">$</span> pnpm
                              install
                           </p>
                           <p className="text-[var(--color-text-muted)]">
                              <span className="text-[var(--color-neon-primary)]">$</span> pnpm dev
                           </p>
                           <p className="text-[var(--color-text-muted)]">
                              <span className="text-[var(--color-success)]">✓</span> Framework ready
                              at{' '}
                              <span className="text-[var(--color-neon-secondary)]">
                                 localhost:3000
                              </span>
                           </p>
                        </div>
                     ...
                     <p className="text-sm text-[var(--color-text-muted)]">
                        Copy components directly into your project or explore the full documentation
            ...
            <div className="text-center mt-16 sm:mt-20 animate-fade-in">
               <p className="text-sm text-[var(--color-text-dim)]">
                  Powered by Next.js 16 · React 19 · TypeScript 5 · Tailwind CSS 4
               </p>
